...
import { CreateRequestEndpoint, EndpointParams, EndpointResult } from "endpoints";
...
class Session extends MessageCommandSession<MessageCommandSendRequestAction, typeof format> {
  ...
  protected async fetch(): Promise<EndpointParams> {
  ...
  protected async onSucceed(result: EndpointResult) {
